...
const passport_http_basic_1 = require("passport-http-basic");
let BasicStrategy = class BasicStrategy extends (0, passport_1.PassportStrategy)(passport_http_basic_1.Strategy, 'basic') {
    constructor() {
